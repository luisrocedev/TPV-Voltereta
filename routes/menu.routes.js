...
router.post('/menu-categories', verifyToken, checkRole('admin','gerente'), (req, res) => {
...
router.put('/menu-categories/:id', verifyToken, checkRole('admin','gerente'), (req, res) => {
  const { id } = req.params;
  const { name, description } = req.body;
...
router.delete('/menu-categories/:id', verifyToken, checkRole('admin','gerente'), (req, res) => {
  const { id } = req.params;
